...
id="email" v-model="form.email" name="email" type="email" autocomplete="email"
      ...
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <input
id="first-name" v-model="form.first_name" type="text" name="first-name" autocomplete="given-name"
                 class="block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"/>
        </div>
...
id="address" v-model="form.address" name="address" type="text" autocomplete="street-address"
      ...
      <div class="col-span-full">
        <label for="address2" class="block text-sm font-medium leading-6 text-white">Apartment, suite, etc.</label>
        <div class="mt-2">
          <input
...
id="city" v-model="form.city" type="text" name="city" autocomplete="address-level2"
      ...
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <input
id="region" v-model="form.state_province" type="text" name="region" autocomplete="address-level1"
                 class="block w-full rounded-md border-0 bg-white/5 py-1.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"/>
        </div>
...
id="phone" v-model="form.phone" name="phone" type="text" autocomplete="tel"
    ...
    <div class="mt-8 flex">
      <div class="flex items-center gap-4">
        ...
        >
          <p v-if="form.recentlySuccessful" class="text-sm text-gray-600 dark:text-gray-400">Saved. Refresh to see
            changes!</p>
        </Transition>
      </div>
    </div>
